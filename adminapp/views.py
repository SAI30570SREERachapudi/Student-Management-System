    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            message = f'Hello {request.user.username},\n\nYou have added a new contact:\n\n' \
                      ...
                      f'Thank you!'
            from_email = 'saisreerachapudi@gmail.com'  # Replace with your email
...
def registerpagelogic(request):
    if request.method == 'POST':
        ...
        first_name = request.POST['firstname']  # Change to first_name
        last_name = request.POST['lastname']  # Change to last_name
        ...
        if pass1 == pass2:
            if User.objects.filter(username=username).exists():
                ...
                user = User.objects.create_user(
                    username=username,
                    password=pass1,
                    first_name=first_name,  # Change to first_name
                    last_name=last_name,  # Change to last_name
                    email=email
                )
                user.save()
